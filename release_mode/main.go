...
func main() {
	// Set mode Gin ke ReleaseMode untuk production
	gin.SetMode(gin.ReleaseMode) // Menggunakan Release mode di production
	...
	// Inisialisasi Gin
	r := gin.New() // Gunakan gin.New() untuk custom mode
